...
**خطوتان دائماً**: `/api/route/preview` يقرأ ويقارن ويعرض الفرق بدون أي كتابة،
ثم `/api/route/apply` يكتب ما عُرض. لا تدمجهما — استبدال روت شهر كامل على أساس
اختيار الملف الصحيح مخاطرة لا تستاهل.
