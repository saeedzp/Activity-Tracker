...
البراندات في جدول `brands` بالقاعدة، لا في الكود. تُدار من `/admin/brands`:
اسم وصورة (رابط https) ولون بديل وترتيب. الإخفاء لا يحذف — الإدخالات السابقة
تحمل الاسم والتصدير يحتاجه.
